...
${nuget_cmd} install src/EconomyKit.UnityClient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/EconomyKit.UnityClient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/EconomyKit.UnityClient.dll \
-recurse:'src/EconomyKit.UnityClient/*.cs' \
-doc:bin/EconomyKit.UnityClient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/EconomyKit.UnityClient.dll was created successfully"
fi
