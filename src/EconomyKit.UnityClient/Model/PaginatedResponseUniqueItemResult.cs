...
{
    /// <summary>
    /// PaginatedResponseUniqueItemResult
    /// </summary>
    [DataContract]
    public partial class PaginatedResponseUniqueItemResult :  IEquatable<PaginatedResponseUniqueItemResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedResponseUniqueItemResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaginatedResponseUniqueItemResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedResponseUniqueItemResult" /> class.
        /// </summary>
        ...
        public PaginatedResponseUniqueItemResult(string next = default(string), string prev = default(string), List<UniqueItemResult> results = default(List<UniqueItemResult>))
        {
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for PaginatedResponseUniqueItemResult and cannot be null");
            }
            else
            {
        ...
        public List<UniqueItemResult> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedResponseUniqueItemResult {\n");
        ...
        {
            return this.Equals(input as PaginatedResponseUniqueItemResult);
        }

        /// <summary>
        /// Returns true if PaginatedResponseUniqueItemResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PaginatedResponseUniqueItemResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedResponseUniqueItemResult input)
        {
            if (input == null)
                return false;
