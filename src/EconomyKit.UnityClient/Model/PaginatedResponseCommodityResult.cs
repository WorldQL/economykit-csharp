...
{
    /// <summary>
    /// PaginatedResponseCommodityResult
    /// </summary>
    [DataContract]
    public partial class PaginatedResponseCommodityResult :  IEquatable<PaginatedResponseCommodityResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedResponseCommodityResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaginatedResponseCommodityResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedResponseCommodityResult" /> class.
        /// </summary>
        ...
        public PaginatedResponseCommodityResult(string next = default(string), string prev = default(string), List<CommodityResult> results = default(List<CommodityResult>))
        {
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for PaginatedResponseCommodityResult and cannot be null");
            }
            else
            {
        ...
        public List<CommodityResult> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedResponseCommodityResult {\n");
        ...
        {
            return this.Equals(input as PaginatedResponseCommodityResult);
        }

        /// <summary>
        /// Returns true if PaginatedResponseCommodityResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PaginatedResponseCommodityResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedResponseCommodityResult input)
        {
            if (input == null)
                return false;
