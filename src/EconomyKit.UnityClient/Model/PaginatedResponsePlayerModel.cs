...
{
    /// <summary>
    /// PaginatedResponsePlayerModel
    /// </summary>
    [DataContract]
    public partial class PaginatedResponsePlayerModel :  IEquatable<PaginatedResponsePlayerModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedResponsePlayerModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaginatedResponsePlayerModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedResponsePlayerModel" /> class.
        /// </summary>
        ...
        public PaginatedResponsePlayerModel(string next = default(string), string prev = default(string), List<PlayerModel> results = default(List<PlayerModel>))
        {
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for PaginatedResponsePlayerModel and cannot be null");
            }
            else
            {
        ...
        public List<PlayerModel> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedResponsePlayerModel {\n");
        ...
        {
            return this.Equals(input as PaginatedResponsePlayerModel);
        }

        /// <summary>
        /// Returns true if PaginatedResponsePlayerModel instances are equal
        /// </summary>
        /// <param name="input">Instance of PaginatedResponsePlayerModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedResponsePlayerModel input)
        {
            if (input == null)
                return false;
